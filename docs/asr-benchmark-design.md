...
| [Die Wissensarchitekt*innen](https://podcasts.homes/@Die_Wissensarchitekt_innen/episodes) | German | professionally produced science interviews | accepted first target-domain source: episodes 1, 2, and 4 are CC BY 4.0, original and publisher-transcript artifacts are digest-pinned, and three ten-minute passages await independent exact-audio gold review |
...
| [vorleser.net](https://www.vorleser.net/) | German | professionally presented audiobooks | high-value permission-only candidate; the [October 2025 terms](https://www.vorleser.net/agb) prohibit AI/STT analysis, research/testing, commercial use, and clip extraction without prior written BUCHFUNK GmbH permission |
