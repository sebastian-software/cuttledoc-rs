...
| [Voxtral Mini 4B Realtime](https://huggingface.co/mistralai/Voxtral-Mini-4B-Realtime-2602/tree/2769294da9567371363522aac9bbcfdd19447add) | Apache-2.0 | official vLLM and Transformers; publisher-linked ExecuTorch, C/MPS, MLX, and Rust paths | measured through a pinned 4-bit MLX reference and repository-owned official-MLX live session at 480/2,400 ms; advance held-out corpus, long audio, common-engine, and C/MPS lifecycle/packaging gates |
