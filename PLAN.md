...
| Synthetic TTS roundtrip (#13) | In progress | The candidate/measurement contract and nine pinned Wikipedia passage selectors are machine-readable; the materializer reproduced and verified both exact revisions locally. The Apple vertical slice and Qwen3-TTS artifact pin are next. |
