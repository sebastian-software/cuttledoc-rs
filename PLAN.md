...
| Held-out target-domain corpus (#18) | In progress | Three CC-BY-4.0 German podcast episodes are accepted, imported, and frozen as three exact ten-minute validation/test passages with five speakers and digest-pinned original, publisher-draft, and normalized-PCM artifacts. Independent human gold review, three professionally recorded German audiobook works/speakers, and identical Apple/Whisper/Qwen/Parakeet/Voxtral runs remain. |
