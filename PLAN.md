...
| Transcript-enhancement model/runtime bakeoff (#20) | In progress | The frozen Gemma challenge comparison early-rejects both safer contracts. In hosted repeat one, Gemini 3.6 Flash, GPT-5.6 Terra, and Claude Sonnet 5 pass 60/60 contract calls and every language macro gate; GPT-5.6 Sol is stopped at 51/60 after an unsupported edit to an already correct English sentence, and Kimi K3 remains resumably incomplete after provider 429s. Captured quality requests cost `$2.6532591`, plus the separately documented `$0.008559` cap calibration. Plan revision 3 permits bounded, explicitly unbilled 429 deferrals but never retries successful or ambiguous paid calls. |
